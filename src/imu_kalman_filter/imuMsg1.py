...
pub1 = rospy.Publisher('imu1', Imu, queue_size=1)
pub2 = rospy.Publisher('imu2', Imu, queue_size=1)
pub3 = rospy.Publisher('imu3', Imu, queue_size=1)
...
while not rospy.is_shutdown():
	...
	imuMsg.header.frame_id = 'base_imu_link1'
	pub1.publish(imuMsg)
	imuMsg.header.stamp= rospy.Time.now()
	imuMsg.header.frame_id = 'base_imu_link2'
	pub2.publish(imuMsg)
	imuMsg.header.stamp= rospy.Time.now()
	imuMsg.header.frame_id = 'base_imu_link3'
	pub3.publish(imuMsg)
	rate.sleep()
